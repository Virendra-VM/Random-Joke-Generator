const jokes = [
  ...
  `What is fas, loud and crunchy? A rocket chip.`,
  ...
  `What did the left eye say to the right eye? Between u, something smells!`,
  ...
  `Sandy’s mum has four kids Nort, Wes, East. What is the name of the fourth child? Sand, obviously!`,
  ...
  `What is brow, hairy and wears sunglasses? A coconut on vacation.`,
  ...
  `Why was 6 afraid of 7? Because ,,9.`,
  ...
  `How much did the man sell his dead batteries for? Nothin, they were free of charge!`,
  ...
  `If an electric train is traveling south at 10 miles per hour and the wind is blowing North at 10 miles per hou, which way does the smoke blow? Fooled you! Electric trains don’t blow smoke.`,
  ...
  `Why does a seagull fly over the sea? Because if it flew over the ba, it would be a baygull.`,
  ...
  `Did you hear the joke about the roof? Never min, it would go over your head.`,
  ...
  ` How can you tell if an ant is a boy or a girl? They’re all girls! If they were boy, they’d be uncles.`,
  ...
  ` What did the fisherman say to the magician? “Pick a co, any cod.”`,
  ...
  ` What do Olympic sprinters eat before a race? Nothin, they fast!`,
  ...
  ` What do you think of that new diner on the moon? Food was goo, but there really wasn’t much atmosphere.`,
  ...
  ` What did the mama elephant say to her kids when they weren’t behaving? “Tus, tusk.”`,
  ...
  ` Can February March? N, but April Ma`]
